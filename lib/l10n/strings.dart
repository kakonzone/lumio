...
class Strings {
  ...
  static const String settingsShareDiagnostics =
      'Share diagnostic data to help improve Lumio';
  ...
  static const String onboardingSourceM3UDesc =
      'Paste a playlist link from your provider';
  static const String onboardingSourceXtream = 'Xtream Codes';
  static const String onboardingSourceXtreamDesc =
      'Enter server details from your IPTV provider';
  static const String onboardingSourceUpload = 'Upload file';
  static const String onboardingSourceUploadDesc =
      'Import an M3U file from your device';
  ...
  static const String onboardingSourceUrlPlaceholder =
  ...
  static const String onboardingAdultContentDesc =
      'Show adult content in results';
  ...
  static const String milestone100HoursMessage =
      'Thanks for watching with Lumio';
  ...
  static const String downloadsEmptySubtitle =
      'Download episodes to watch without internet.';
  ...
  static const String noEpgSubtitle =
      'Programs will appear when the provider sends them.';
  ...
  static const String playlistParseFailedTitle =
      'We couldn\'t read that playlist.';
  static const String playlistParseFailedSubtitle =
      'Make sure the link points to a valid M3U file.';
  ...
  /// Permission denied
  static const String permissionDeniedTitle =
      'Lumio needs [permission] for this.';
  ...
  static const String signOutSubtitle =
      'You\'ll need to sign in again to keep watching.';

  /// Delete playlist
  static const String deletePlaylistTitle = 'Remove this playlist?';
  static const String deletePlaylistSubtitle =
      'Your favorites and history stay safe.';
  ...
  static const String resetAppSubtitle =
      'Everything goes back to default. Your account stays.';
  ...
  static const String storagePermissionSubtitle =
      'to save downloads for offline watching.';
  ...
  static const String notificationsPermissionSubtitle =
      'about reminders you set and stream updates.';

  /// Camera permission (for QR import)
  static const String cameraPermissionTitle = 'Scan a QR code';
  static const String cameraPermissionSubtitle =
      'to import your playlist instantly.';
  ...
  /// Sports
  static const String noChannelsInSport =
      'No live channels in {sport} right now';

  /// Categories
  static const String noLiveChannelsInCategory =
      'No live channels in {category} right now';
  ...
  static const String addedToFavoritesChannel =
      '{channelName} added to favorites';
