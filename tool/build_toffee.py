#!/usr/bin/env python3
"""Generate lib/data/toffee_channels.dart from embedded Toffee channel spec."""
from __future__ import annotations

from pathlib import Path

LINEAR_COOKIE = 'Edge-Cache-Cookie=URLPrefix=aHR0cHM6Ly9ibGRjbXByb2QtY2RuLnRvZmZlZWxpdmUuY29t:Expires=1779162983:KeyName=prod_linear:Signature=coIPiYIHdJUBxX6RJiONIgupUvFFZ2gINTVuRpIqZy6G5M2osTI7NHqwS5AwjSTP8vWhupE9Cs8ilEcyA_wlDQ'
LIVE_COOKIE = 'Edge-Cache-Cookie=URLPrefix=aHR0cHM6Ly9tcHJvZC1jZG4udG9mZmVlbGl2ZS5jb20:Expires=1779040584:KeyName=prod_live_events:Signature=PTc2tpT6rPE8KKFcOKpDC8uY9Bt457f05vWbXyvQ7s9VTYXVPtiiSflnkHQDwj4QGuzL7ZMbpsbwRN29-neLCQ'
USER_AGENT = 'okhttp/4.11.0'

OUTPUT = Path(__file__).resolve().parent.parent / "lib" / "data" / "toffee_channels.dart"

# All Toffee channels: name, category, link, logo (from product spec).
CHANNELS: list[dict[str, str]] = [
  ...
  },
  {
    "category": "News Channel",
    "name": "Desh TV",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/desh_tv/playlist.m3u8",
  ...
  },
  {
    "category": "বাংলাদেশী চ্যানেল",
    "name": "Nexus TV",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/nexus_tv/playlist.m3u8",
  ...
  },
  {
    "category": "বাংলাদেশী চ্যানেল",
    "name": "Movie Bangla",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/movie_bangla/playlist.m3u8",
  ...
  },
  {
    "category": "বাংলাদেশী চ্যানেল",
    "name": "Mohona TV",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/mohona_tv/playlist.m3u8",
  ...
  },
  {
    "category": "বাংলাদেশী চ্যানেল",
    "name": "Rajdhani TV",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/rajdhani_tv/playlist.m3u8",
  ...
  },
  {
    "category": "বাংলাদেশী চ্যানেল",
    "name": "Islamic TV",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/islamic_tv/playlist.m3u8",
  ...
  },
  {
    ...
    "name": "BD vs PK",
    "link": "https://mprod-cdn.toffeelive.com/live/bdvsnz26/index.m3u8",
    "logo": "https://assets-prod.services.toffeelive.com/w_480,q_75,f_webp/ljE2lZ0BNnOkwJLW9lrg/posters/b4bee75a-b8a3-4594-b562-6e3910d71625.png"
  },
  {
    "category": "Sports Channels",
    "name": "Euro Sport HD",
  ...
  },
  {
    "category": "Entertainment Channels",
    "name": "Sony Aat VIP",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/sonyaath/playlist.m3u8",
  ...
  },
  {
    ...
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/sonyentertainmnt_hd/playlist.m3u8",
  ...
  },
  {
    ...
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/sony_max_hd/playlist.m3u8",
  ...
  },
  {
    ...
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/zee_bangla_cinema/playlist.m3u8",
  ...
  },
  {
    "category": "Movie Channels",
    "name": "Zee Bollywood",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/zee_bollywood/playlist.m3u8",
  ...
  },
  {
    "category": "Movie Channels",
    "name": "Zee Action",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/zee_action/playlist.m3u8",
  ...
  },
  {
    "category": "Movie Channels",
    "name": "SONY MAX 2 VIP",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/sonymax_2/playlist.m3u8",
  ...
  },
  {
    "category": "Infotainment",
    "name": "Discovery",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/discovery_sd/playlist.m3u8",
    "logo": "https://images.toffeelive.com/images/program/18097/logo/240x240/mobile_logo_297723001673195119.png"
  },
  {
    "category": "Infotainment",
    "name": "Discovery Science",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/discovery_science/playlist.m3u8",
    "logo": "https://images.toffeelive.com/images/program/378/logo/240x240/mobile_logo_604754001673177502.png"
  },
  {
    "category": "Infotainment",
    "name": "Discovery Turbo",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/discovery_turbo/playlist.m3u8",
  ...
  },
  {
    "category": "Entertainment Channels",
    "name": "& Pictures HD",
    "link": "https://bldcmprod-cdn.toffeelive.com/cdn/live/andpicture_hd/playlist.m3u8",
    "logo": "https://images.toffeelive.com/images/program/4570/logo/240x240/mobile_logo_000080001675856893.png"
  }
]


def map_category(raw: str, name: str) -> str:
    n = name.lower()
    if raw == "LIVE":
        if "movie" in n:
            return "Movies"
        ...
        return "Sports"
    mapping = {
        "News Channel": "Bangladesh",
        "বাংলাদেশী চ্যানেল": "Bangladesh",
        "Sports Channels": "Sports",
        "Kids": "Kids",
        "Entertainment Channels": "Entertainment",
        "Movie Channels": "Movies",
        "Infotainment": "English",
    }
    return mapping.get(raw, "Entertainment")


def map_country(category: str) -> str:
...
def cookie_for_link(link: str) -> str:
    if "://mprod-cdn.toffeelive.com" in link:
        return LIVE_COOKIE
    return LINEAR_COOKIE
...
def generate() -> str:
    lines: list[str] = [
        "// GENERATED by tool/build_toffee.py — do not edit by hand.",
        "import '../models/model.dart';",
        "",
        "class ToffeeChannels {",
        "  ToffeeChannels._();",
        "",
        f"  static const _linearCookie = {dart_quote(LINEAR_COOKIE)};",
        f"  static const _liveCookie = {dart_quote(LIVE_COOKIE)};",
        f"  static const _ua = {dart_quote(USER_AGENT)};",
        "",
        "  static ChannelModel _t(",
        "    String id,",
        "    String name,",
        "    String category,",
        "    String country,",
    ...
    for i, ch in enumerate(CHANNELS):
        name = ch["name"]
        cat = map_category(ch["category"], name)
        country = map_country(cat)
        link = ch["link"]
        logo = ch.get("logo") or ""
        cookie = cookie_for_link(link)
        lines.extend(
            [
                "    _t(",
                f"      {dart_quote(f'toffee_{i}')},",
                f"      {dart_quote(name)},",
                f"      {dart_quote(cat)},",
                f"      {dart_quote(country)},",
                f"      {dart_quote(link)},",
                f"      {dart_quote(logo)},",
                f"      {dart_quote(cookie)},",
                "    ),",
...
def main() -> None:
    ...
    print(f"Wrote {len(CHANNELS)} channels to {OUTPUT}")
